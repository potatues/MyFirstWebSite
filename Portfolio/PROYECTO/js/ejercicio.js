function validacion () {
	...
	if(usuario == "junito@gmail.com" && password == "1234") {
		alert('Bienvenido adm');
		window.location.href = '../Administrador.html'

	} else if (usuario == "junito2@gmail.com" && password == "1234"){

		alert('Bienvenido cliente');
		window.location.href = '../cliente.html';
	}else{
		alert('Error : Verifique su correo y contraseña')
	}
