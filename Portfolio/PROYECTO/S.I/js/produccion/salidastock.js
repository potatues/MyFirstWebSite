...
function delete_row(no)
{
  swal({
  title: "¿Estás seguro?",
  text: "Una vez realizaoo, no hay vuelta atrás.",
  icon: "warning",
  buttons: true,
  dangerMode: true,
})
...
function add_row()
{
 ...
 var row = table.insertRow(table_len).outerHTML="<tr id='row"+table_len+"'><td id='name_row"+table_len+"'>"+new_name+"</td><td id='country_row"+table_len+"'>"+new_country+"</td><td id='age_row"+table_len+"'>"+new_age+"</td><td id='number"+table_len+"'>"+new_numero+"</td><td>  <img class='kl-b-2 kl-shine kl-spin delete' src='../../img/recycle-bin.png' onclick='delete_row("+table_len+")' style='cursor: pointer;' width='30' height='30'> <img class='kl-b-2 kl-shine kl-spin edit' src='../../img/wrench.png' id='edit_button"+table_len+"' style='cursor: pointer;' onclick='edit_row("+table_len+")'  width='30' height='30'><img class='kl-b-2 kl-shine kl-spin save' src='../../img/save.png' id='save_button"+table_len+"' style='cursor: pointer;' onclick='save_row("+table_len+")' width='25' height='25'> </td></tr>";
